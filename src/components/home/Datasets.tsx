    ...
    return (
        <div className={'bg-dark-blue-bg '}>
            <div className={'px-5 py-14'}>
                <h1 className={'lg:text-5xl md:text-4xl text-3xl font-bold text-center leading-relaxed'}>
                    We Provide AI<br/>
                    Training Datasets.
                </h1>
                <div className={'mt-10'}>
                            ...
                            <SwiperSlide>
                                <div className={'w-80 space-y-7 bg-secondary-bg hover:bg-[#474D62] transition-all duration-300 rounded-lg overflow-hidden mx-auto group cursor-pointer'}>
                                    ...
                                    <div className={'px-3 py-4 space-y-6 relative'}>
                                        ...
                                        <div className={'absolute bottom-6 right-6 hidden group-hover:block transition-all duration-300'}><Image src={StarImg} alt={' '}/></div>
                                    </div>
                                </div>
                            </SwiperSlide>
                        ))}
